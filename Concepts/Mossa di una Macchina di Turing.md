> [!definition]
> Supponiamo che la [[Macchine di Turing|MdT]] M si trovi nella [[Descrizione istantanee delle MdT|configurazione]] (ID) corrente:
...
## Casi particolari
Sempre considerando lo stesso caso della [[funzione di transizione delle Macchine di Turing|delta]]: $\delta(q,X_i) = (p, y, L)$ e la stessa [[Macchine di Turing|Macchina di Turing]] M:
- $i = 1$, allora 
