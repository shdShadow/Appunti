...
> [!caution]
> $\varepsilon$ in questo caso non rappresenta la stringa vuota, ma un simbolo a se stante che indica la [[Epsilon-mossa]], cioe' un passo di computazione particolare che non consuma nessun simbolo dalla [[stringa]] in input.
