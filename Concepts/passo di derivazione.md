...
> Sia $\alpha A\beta$ una forma sentenziale tale che :
> - $A \in V$
> - $\alpha,\beta \in (V \cup T)*$
> Sia $A \to \gamma$ una regola di produzione. Allora:
> $$ \alpha A \beta \Rightarrow \alpha \gamma \beta $$

### Osservazione
- Sto dicendo che in un passo di derivazione io alpha e beta li riscrivo tali e quali mentre A lo sostituisco mediante la regola di produzione. Abbiamo quindi una relazione binaria tra le 2 forme sentenziali perche' esiste una [[regole-di-pruduzione]] che mi permette di pasasre da una forma all'altra
