...
known: "True"
---
 Ma quindi quale e' questa classe? In realta' l'abbiamo gia' visto e sono (almeno) i [[CFL - Context Free Language]], generati da [[Grammatiche CF - CFG|CFG]]. Vediamo quindi le [[trasformazioni tra CFG, PDA per stack vuoto e PDA per Stato Finale|trasformazioni possibili]].
