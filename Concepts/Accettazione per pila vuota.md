# Definizione 
Sia $P = (Q,\Sigma, \Gamma, \delta, q_0, Z_0, F)$ un [[Automi a Pila (PDA)|PDA]]. Il [[CFL - Context Free Language|linguaggio]] accettato da P per pila vuota e':
...
Siccome non vengono usati, spesso nella definizione del [[Automi a Pila (PDA)|PDA]] l'insieme F degli stati finali viene proprio omesso.