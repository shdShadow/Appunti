> [!definition]
> Una **configurazione** o **descrizione istantanea** di un [[Automi a Pila (PDA)|PDA]] e' una _tripla_ $(q, w, \gamma)$ dove:
...
## Osservazioni
- Rappresenta come una fotografia dell' [[Automi a Pila (PDA)|Automa a Pila]] in un certo istante. Rappresentano lo stato attuale dell'automa